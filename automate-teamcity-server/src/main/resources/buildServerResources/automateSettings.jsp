...
<tr id="<%= BrowserStackParameters.EnvVars.BROWSERSTACK_USER %>.container">
    ...
    <td>
        ...
        <span class="smallNote">
            Set your BrowserStack Automate username. You can get it from <a href="https://www.browserstack.com/accounts/settings" target="_blank">here</a>.
        </span>
...
<tr id="<%= BrowserStackParameters.EnvVars.BROWSERSTACK_ACCESSKEY %>.container">
    ...
    <td>
        ...
        <span class="smallNote">
            Set your BrowserStack Automate access key. You can get it from <a href="https://www.browserstack.com/accounts/settings" target="_blank">here</a>.
        </span>
...
<tr id="<%= BrowserStackParameters.EnvVars.BROWSERSTACK_LOCAL %>.container">
    ...
    <td>
        ...
        <span class="smallNote">
            ...
            Skip this if you are using BrowserStack Local bindings in your code.<br/>
            <ul>
